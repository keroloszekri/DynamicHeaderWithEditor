...
namespace Computony.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,SubCatID,Content")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,SubCatID")] Product product)
        {
            if (ModelState.IsValid)
            {
